...
def time_clock_in():
    try:
        ...
        Waits.WaitElementLoaded(20, data["TIMECARD"]["pop_up_edit"])
        time.sleep(3)
...
def add_clock_in_clock_out(user_id):
    try:
    ...
    try:
        ...
        time.sleep(5)
        choose_user = Commands.ClickElement(data["TIMECARD"]["choose_user"]) 
        select_user = Commands.InputElement(data["TIMECARD"]["dashboard_search"], user_id)
        select_user.send_keys(Keys.ENTER)
        time.sleep(2)
        Commands.ClickElement(data["TIMECARD"]["click_first_choice"] % user_id) 
...
def manager(user_id):
    ...
    Waits.WaitElementLoaded(20, data["TIMECARD"]["setting_manager"])
    time.sleep(2)
    ...
    add_manager = Commands.InputElement(data["TIMECARD"]["dashboard_search"], user_id)
    ...
    if str(x) == "Select Department/User":
        ...
        try:
            ...
            if error.is_displayed():
                ...
                search = Commands.InputElement(data["TIMECARD"]["search_duplicate"], user_id)
...
def total_manager(user_id):
    ...
    search_total_manager = Commands.InputElement(data["TIMECARD"]["search_total_manager"], user_id)
...
def work_schedule(day_list):
    ...
    try:
        ...
        if noty_success.text in noty_event_list:
            ...
            search_user = Commands.InputElement(data["TIMECARD"]["search_user"], user_id)
...
def delete_punch(user_id):
    ...
    time.sleep(5)
    tl_search2 = Commands.InputElement(data["TIMECARD"]["search"], user_id)
...
def weekly_status(user_id):
    ...
    try:
        ...
        ws_search = Commands.InputElement(data["TIMECARD"]["ws_search"], user_id)
...
def daily_status(user_id):
    ...
    try:
        ...
        search = Commands.InputElement(data["TIMECARD"]["search"], user_id)
        search.send_keys(Keys.ENTER)
        time.sleep(5)
        Commands.ClickElement(data["TIMECARD"]["click_first_choice"] % user_id)
        Commands.ClickElement(data["TIMECARD"]["open_searchbox"]) 
...
def daily_status2(working_time, user_id):
    working_number1 = working_time["working_number1"]
    break_number1 = working_time["break_number1"]
    ...
    try:
        ...
        search2 = Commands.InputElement(data["TIMECARD"]["search2"], user_id)
...
def weekly_status2(user_id):
    try:
        ...
        Commands.ClickElement(data["TIMECARD"]["open_search_box"]) 
        ws_search2 = Commands.InputElement(data["TIMECARD"]["ws_search2"], user_id)
...
def company_timecard_reports(user_id):
    try:
        time.sleep(5)
...
def work_place():
    ...
    try:
        ...
        Commands.InputElement(data["TIMECARD"]["holiday_name"], "Holiday")
    ...
    try:
        ...
        time.sleep(3)
        Commands.ClickElement("//*[@id='app']//li[1]//span[contains(@class, 'save')]") 
        time.sleep(5)
...
def dashboard():
    try:
        ...
        # tl_search2 = driver.find_element_by_xpath(data["TIMECARD"]["ws_search2"])
        # tl_search2.send_keys(data["name_keyword"][0])
        tl_search2 = Commands.InputElement(data["TIMECARD"]["search"], data["name_keyword"][0])
        tl_search2.send_keys(Keys.ENTER)
        time.sleep(5)
        Commands.ClickElement(data["TIMECARD"]["search_users"]) 
        time.sleep(5)
...
def exception_users(user_id):
    ...
    input_exc_user = Commands.InputElement(data["TIMECARD"]["input_exc_user"], user_id)
    time.sleep(2)
...
def outside_users(user_id):   
    ...
    input_out_user = Commands.InputElement(data["TIMECARD"]["input_out_user"], user_id)
    time.sleep(2)
...
def arbitrary_decision(user_id):
    Logging("")
    ...
    input_arbitrary_user = Commands.InputElement(data["TIMECARD"]["input_arbitrary_user"], user_id)
    time.sleep(2)
...
def timecard(user_id):
    nightwork()
    breaktime()
    clock_out()

    delete_punch(user_id)
    add_clock_in_clock_out(user_id)
    timecard_data = check_time()
    date_clock_in = timesheet_list(**timecard_data)
    timecard_data["date_clock_in"] = date_clock_in
    # report_list1(**timecard_data)
    ...
    manager(user_id)
    total_manager(user_id)
    delete_punch(user_id)
    

def time_card(user_id):
    # # # # # Napproval_OT()
    weekly_status(user_id)
    daily_status(user_id)
    ...
    daily_status2(working_time, user_id)

    weekly_status2(user_id)

    company_timecard_reports(user_id)
    ...
    exception_users(user_id)

    outside_users(user_id)

    arbitrary_decision(user_id)
